...
export const actions = {
	updateDraft: async ({ request, locals, fetch, params }: import('./$types').RequestEvent) => {
	...
	uploadArchive: async ({ request, locals, fetch, params }: import('./$types').RequestEvent) => {
		if (!locals.accessToken) {
	...
	uploadImages: async ({ request, locals, fetch, params }: import('./$types').RequestEvent) => {
		if (!locals.accessToken) {
	...
	deleteImage: async ({ request, locals, fetch, params }: import('./$types').RequestEvent) => {
		if (!locals.accessToken) {
	...
	submitReview: async ({ locals, fetch, params }: import('./$types').RequestEvent) => {
		if (!locals.accessToken) {
