...
type LayoutRouteId = RouteId | "/" | "/account" | "/account/general" | "/account/library" | "/account/orders" | "/account/purchase-history" | "/account/security" | "/admin" | "/admin/moderation" | "/admin/moderation/[revisionId]" | "/admin/products" | "/admin/products/[productId]" | "/admin/users" | "/admin/users/[userId]" | "/admin/wallet" | "/auth/login" | "/auth/register" | "/products" | "/products/[slug]" | "/seller/dashboard" | "/seller/products" | "/seller/products/new" | "/seller/products/[productId]" | "/seller/settings" | "/seller/stats" | null
type LayoutParams = RouteParams & { revisionId?: string; productId?: string; userId?: string; slug?: string }
